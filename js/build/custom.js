...
(function ($) {
    ...
    //Sticky Widget
    if (triphub_custom.sticky_widget == '1' && $(window).width() > 1024) {
        $('#secondary').addClass('sticky-widget');

        if (triphub_custom.ed_sticky_header == '1') {
    ...
    if (winWidth > 1024 && triphub_custom.ed_sticky_form == 1) {
...
jQuery.fn.triphubIsOnScreen = function () {

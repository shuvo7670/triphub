...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					...
					esc_html( _nx( '%1$s Comment', '%1$s Comments', get_comments_number(), 'comments title', 'triphub' ) ),
		...
		<ol class="comment-list">
			<?php
				wp_list_comments( array(
					'style'      => 'ol',
					'short_ping' => true,
                    'callback'   => 'triphub_comment_callback',
                    'avatar_size' => 48,
				) );
			?>
		</ol><!-- .comment-list -->
		...
		if ( ! comments_open() ) :
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'triphub' ); ?></p>
			<?php
		endif;

...
function triphub_dynamic_css(){
	$typo_defaults   = triphub_get_typography_defaults();
	$defaults        = triphub_get_color_defaults();
	$site_defaults   = triphub_get_site_defaults();
	$layout_defaults = triphub_get_general_defaults();
	$button_defaults = triphub_get_button_defaults();
	...
	$primary_font_family       = triphub_get_font_family( $primary_font );
	$sitetitle_font_family     = triphub_get_font_family( $sitetitle );
	$btn_font_family           = triphub_get_font_family( $button );
	$heading_one_font_family   = triphub_get_font_family( $heading_one );
	$heading_two_font_family   = triphub_get_font_family( $heading_two );
	$heading_three_font_family = triphub_get_font_family( $heading_three );
	$heading_four_font_family  = triphub_get_font_family( $heading_four );
	$heading_five_font_family  = triphub_get_font_family( $heading_five );
	$heading_six_font_family   = triphub_get_font_family( $heading_six );
	...
	$rgb                = triphub_hex2rgb( triphub_sanitize_rgba( $primary_color ) );
	$secondary_color    = get_theme_mod( 'secondary_color', $defaults['secondary_color'] );
	$rgb2               = triphub_hex2rgb( triphub_sanitize_rgba( $secondary_color ) );
	$body_font_color    = get_theme_mod( 'body_font_color', $defaults['body_font_color'] );
	$rgb3               = triphub_hex2rgb( triphub_sanitize_rgba( $body_font_color ) );
	$heading_color      = get_theme_mod( 'heading_color', $defaults['heading_color'] );
	$rgb4               = triphub_hex2rgb( triphub_sanitize_rgba( $heading_color ) );
	$section_bg_color   = get_theme_mod( 'section_bg_color', $defaults['section_bg_color'] );
	$rgb5               = triphub_hex2rgb( triphub_sanitize_rgba( $section_bg_color ) );
	$background_color   = get_theme_mod( 'site_bg_color', $defaults['site_bg_color'] );
	$rgb6               = triphub_hex2rgb( triphub_sanitize_rgba( $background_color ) );
	...
	$rgb7                  = triphub_hex2rgb( triphub_sanitize_rgba( $top_header_text_color ) );
    ...
    :root {
		--e-global-color-primary_color  : <?php echo triphub_sanitize_rgba( $primary_color ); ?>;
		--e-global-color-secondary_color: <?php echo triphub_sanitize_rgba( $secondary_color ); ?>;
		--e-global-color-body_font_color: <?php echo triphub_sanitize_rgba( $body_font_color ); ?>;
		--e-global-color-heading_color  : <?php echo triphub_sanitize_rgba( $heading_color ); ?>;
		--triphub-primary-color             : <?php echo triphub_sanitize_rgba( $primary_color ); ?>;
		--triphub-primary-color-rgb         : <?php printf('%1$s, %2$s, %3$s', $rgb[0], $rgb[1], $rgb[2] ); ?>;
		--triphub-secondary-color           : <?php echo triphub_sanitize_rgba( $secondary_color ); ?>;
		--triphub-secondary-color-rgb       : <?php printf('%1$s, %2$s, %3$s', $rgb2[0], $rgb2[1], $rgb2[2] ); ?>;
		--triphub-body-font-color           : <?php echo triphub_sanitize_rgba( $body_font_color ); ?>;
		--triphub-body-font-color-rgb       : <?php printf('%1$s, %2$s, %3$s', $rgb3[0], $rgb3[1], $rgb3[2] ); ?>;
		--triphub-heading-color             : <?php echo triphub_sanitize_rgba( $heading_color ); ?>;
		--triphub-heading-color-rgb         : <?php printf('%1$s, %2$s, %3$s', $rgb4[0], $rgb4[1], $rgb4[2] ); ?>;
		--triphub-section-bg-color          : <?php echo triphub_sanitize_rgba( $section_bg_color ); ?>;
		--triphub-section-bg-color-rgb      : <?php printf('%1$s, %2$s, %3$s', $rgb5[0], $rgb5[1], $rgb5[2] ); ?>;
		--triphub-background-color          : <?php echo triphub_sanitize_rgba( $background_color ); ?>;
		--triphub-background-color-rgb      : <?php printf('%1$s, %2$s, %3$s', $rgb6[0], $rgb6[1], $rgb6[2] ); ?>;

        --triphub-btn-text-initial-color: <?php echo triphub_sanitize_rgba( $btn_text_color ); ?>;
        --triphub-btn-text-hover-color: <?php echo triphub_sanitize_rgba( $btn_text_hover_color ); ?>;
        --triphub-btn-bg-initial-color: <?php echo triphub_sanitize_rgba( $btn_bg_color ); ?>;
        --triphub-btn-bg-hover-color: <?php echo triphub_sanitize_rgba( $btn_bg_hover_color ); ?>;
        --triphub-btn-border-initial-color: <?php echo triphub_sanitize_rgba( $btn_border_color ); ?>;
        --triphub-btn-border-hover-color: <?php echo triphub_sanitize_rgba( $btn_border_hover_color ); ?>;

        --triphub-primary-font-family: <?php echo wp_kses_post( $primary_font_family ); ?>;     
        --triphub-primary-font-weight: <?php echo esc_html( $primary_font['weight'] ); ?>;
        --triphub-primary-font-transform: <?php echo esc_html( $primary_font['transform'] ); ?>;

        --triphub-btn-font-family: <?php echo wp_kses_post( $btnFontFamily ); ?>;     
        --triphub-btn-font-weight: <?php echo esc_html( $button['weight'] ); ?>;
        --triphub-btn-font-transform: <?php echo esc_html( $button['transform'] ); ?>;
        --triphub-btn-roundness-top: <?php echo absint( $button_roundness['top'] ); ?>px;
        --triphub-btn-roundness-right: <?php echo absint( $button_roundness['right'] ); ?>px;
        --triphub-btn-roundness-bottom: <?php echo absint( $button_roundness['bottom'] ); ?>px;
        --triphub-btn-roundness-left: <?php echo absint( $button_roundness['left'] ); ?>px;
        --triphub-btn-padding-top: <?php echo absint( $button_padding['top'] ); ?>px;
        --triphub-btn-padding-right: <?php echo absint( $button_padding['right'] ); ?>px;
        --triphub-btn-padding-bottom: <?php echo absint( $button_padding['bottom'] ); ?>px;
        --triphub-btn-padding-left: <?php echo absint( $button_padding['left'] ); ?>px;
	}

    .site-header{
        --triphub-menu-items-spacing: <?php echo absint( $menu_item_spacing ); ?>px;
        --triphub-menu-dropdown-width: <?php echo absint( $menu_dropdown_width ); ?>px;
        --triphub-btn-text-initial-color: <?php echo triphub_sanitize_rgba( $header_btn_text_color ); ?>;
        --triphub-btn-text-hover-color: <?php echo triphub_sanitize_rgba( $header_btn_text_hover_color ); ?>;
        --triphub-btn-bg-initial-color: <?php echo triphub_sanitize_rgba( $header_btn_bg_color ); ?>;
        --triphub-btn-bg-hover-color: <?php echo triphub_sanitize_rgba( $header_btn_bg_hover_color ); ?>;
    }

    .notification-bar{
        --triphub-bg-color: <?php echo triphub_sanitize_rgba( $notifi_bg_color ); ?>;
        --triphub-text-color: <?php echo triphub_sanitize_rgba( $notifi_text_color ); ?>;
    }
    ...
    .site-footer{
        --triphub-uf-text-color: <?php echo triphub_sanitize_rgba( $uf_text_color ); ?>;
        --triphub-uf-bg-color: <?php echo triphub_sanitize_rgba( $uf_bg_color ); ?>;
        --triphub-uf-link-hover-color: <?php echo triphub_sanitize_rgba( $uf_link_hover_color ); ?>;
        --triphub-uf-widget-heading-color: <?php echo triphub_sanitize_rgba( $uf_heading_color ); ?>;
        --triphub-bf-text-color: <?php echo triphub_sanitize_rgba( $bf_text_color ); ?>;
        --triphub-bf-bg-color: <?php echo triphub_sanitize_rgba( $bf_bg_color ); ?>;
        --triphub-bf-link-initial-color: <?php echo triphub_sanitize_rgba( $bf_link_initial_color ); ?>;
        --triphub-bf-link-hover-color: <?php echo triphub_sanitize_rgba( $bf_link_hover_color ); ?>;
    }

    .header-layout-1 .header-m{
        --triphub-top-header-bg-color: <?php echo triphub_sanitize_rgba( $top_header_bg_color ); ?>;
        --triphub-top-header-text-color: <?php echo triphub_sanitize_rgba( $top_header_text_color ); ?>;
		--triphub-top-header-text-color-rgb: <?php printf('%1$s, %2$s, %3$s', $rgb7[0], $rgb7[1], $rgb7[2] ); ?>;
    }
    ...
    @media (min-width: 1024px){
        :root{
            --triphub-primary-font-size   : <?php echo absint( $primarydesktopFontSize ); ?>px;
            --triphub-primary-font-height : <?php echo floatval( $primarydesktopHeight ); ?>em;
            --triphub-primary-font-spacing: <?php echo absint( $primarydesktopSpacing ); ?>px;

            --triphub-container-width  : <?php echo absint($container_width); ?>px;
            --triphub-centered-maxwidth: <?php echo absint($fullwidth_centered); ?>px;

            --triphub-btn-font-size   : <?php echo absint( $btndesktopFontSize ); ?>px;
            --triphub-btn-font-height : <?php echo floatval( $btndesktopHeight ); ?>em;
            --triphub-btn-font-spacing: <?php echo absint( $btndesktopSpacing ); ?>px;
        }

        .main-content-wrapper{
            --triphub-sidebar-width: <?php echo absint($sidebar_width); ?>%;
        }

        aside.widget-area {
            --triphub-widget-spacing: <?php echo absint($widgets_spacing); ?>px;
        }

        .to_top{
            --triphub-scroll-to-top-size: <?php echo absint($scroll_top_size); ?>px;
        }
    ...
    @media (min-width: 767px) and (max-width: 1024px){
        :root{
            --triphub-primary-font-size: <?php echo absint( $primarytabletFontSize ); ?>px;
            --triphub-primary-font-height: <?php echo floatval( $primarytabletHeight ); ?>em;
            --triphub-primary-font-spacing: <?php echo absint( $primarytabletSpacing ); ?>px;

            --triphub-container-width  : <?php echo absint($tablet_container_width); ?>px;
            --triphub-centered-maxwidth: <?php echo absint($tablet_fullwidth_centered); ?>px;

            --triphub-btn-font-size   : <?php echo absint( $btntabletFontSize ); ?>px;
            --triphub-btn-font-height : <?php echo floatval( $btntabletHeight ); ?>em;
            --triphub-btn-font-spacing: <?php echo absint( $btntabletSpacing ); ?>px;
        }

        .main-content-wrapper{
            --triphub-sidebar-width: <?php echo absint($tablet_sidebar_width); ?>%;
        }

        aside.widget-area {            
            --triphub-widget-spacing: <?php echo absint($tablet_widgets_spacing); ?>px;
        }

        .to_top{
            --triphub-scroll-to-top-size: <?php echo absint($tablet_scroll_top_size); ?>px;
        }
    ...
    @media (max-width: 767px){
        :root{
            --triphub-primary-font-size: <?php echo absint( $primarymobileFontSize ); ?>px;
            --triphub-primary-font-height: <?php echo floatval( $primarymobileHeight ); ?>em;
            --triphub-primary-font-spacing: <?php echo absint( $primarymobileSpacing ); ?>px;

            --triphub-container-width  : <?php echo absint($mobile_container_width); ?>px;
            --triphub-centered-maxwidth: <?php echo absint($mobile_fullwidth_centered); ?>px;

            --triphub-btn-font-size   : <?php echo absint( $btnmobileFontSize ); ?>px;
            --triphub-btn-font-height : <?php echo floatval( $btnmobileHeight ); ?>em;
            --triphub-btn-font-spacing: <?php echo absint( $btnmobileSpacing ); ?>px;
        }
        
        aside.widget-area {
            --triphub-widget-spacing: <?php echo absint($mobile_widgets_spacing); ?>px;
        }
        ...
        .to_top{
            --triphub-scroll-to-top-size: <?php echo absint($mobile_scroll_top_size); ?>px;
        }
...
add_action( 'wp_head', 'triphub_dynamic_css', 101 );

/**
* Function for sanitizing Hex color 
*/
function triphub_sanitize_hex_color( $color ){
    if ( '' === $color )
        return '';
 ...
 * Convert '#' to '%23'
*/
function triphub_hash_to_percent23( $color_code ){
    $color_code = str_replace( "#", "%23", $color_code );
    return $color_code;
}


if ( ! function_exists( 'triphub_gutenberg_inline_style' ) ) : 
    /**
     * Gutenberg Dynamic Style
     */
    function triphub_gutenberg_inline_style(){
        ...
        $custom_css = ':root .block-editor-page {
            --triphub-primary-color   : ' . triphub_sanitize_rgba( $primary_color ) . ';
            --triphub-primary-color-rgb: ' . $rgb[0] . ',' . $rgb[1] .',' . $rgb[2] . ';
            --triphub-secondary-color : ' . triphub_sanitize_rgba( $secondary_color ) . ';
            --triphub-secondary-color-rgb:' . $rgb2[0] . ',' . $rgb2[1] .',' . $rgb2[2] . ';
            --triphub-body-font-color : ' . triphub_sanitize_rgba( $body_font_color ) . ';
            --triphub-body-font-color-rgb:' . $rgb3[0] . ',' . $rgb3[1] .',' . $rgb3[2] . ';
            --triphub-heading-color   : ' . triphub_sanitize_rgba( $heading_color ) . ';
            --triphub-heading-color-rgb:' . $rgb4[0] . ',' . $rgb4[1] .',' . $rgb4[2] . ';
            --triphub-section-bg-color: ' . triphub_sanitize_rgba( $section_bg_color ) . ';
            --triphub-section-bg-color-rgb:' . $rgb5[0] . ',' . $rgb5[1] .',' . $rgb5[2] . ';
            --triphub-background-color: ' . triphub_sanitize_rgba( $background_color ) . ';
            --triphub-background-color-rgb:' . $rgb6[0] . ',' . $rgb6[1] .',' . $rgb6[2] . ';

            --triphub-btn-text-initial-color  : ' . triphub_sanitize_rgba( $btn_text_color ) . ';
            --triphub-btn-text-hover-color    : ' . triphub_sanitize_rgba( $btn_text_hover_color ) . ';
            --triphub-btn-bg-initial-color    : ' . triphub_sanitize_rgba( $btn_bg_color ) . ';
            --triphub-btn-bg-hover-color      : ' . triphub_sanitize_rgba( $btn_bg_hover_color ) . ';
            --triphub-btn-border-initial-color: ' . triphub_sanitize_rgba( $btn_border_color ) . ';
            --triphub-btn-border-hover-color  : ' . triphub_sanitize_rgba( $btn_border_hover_color ) . ';

            --triphub-primary-font-family   : ' . wp_kses_post( $primary_font_family ) . ';
            --triphub-primary-font-weight   : ' . esc_html( $primary_font['weight'] ) . ';
            --triphub-primary-font-transform: ' . esc_html( $primary_font['transform'] ) . ';

            --triphub-btn-font-family     : ' . wp_kses_post( $btnFontFamily ) . ';
            --triphub-btn-font-weight     : ' . esc_html( $button['weight'] ) . ';
            --triphub-btn-font-transform  : ' . esc_html( $button['transform'] ) . ';
            --triphub-btn-roundness-top   : ' . absint( $button_roundness['top'] ) . 'px;
            --triphub-btn-roundness-right : ' . absint( $button_roundness['right'] ) . 'px;
            --triphub-btn-roundness-bottom: ' . absint( $button_roundness['bottom'] ) . 'px;
            --triphub-btn-roundness-left  : ' . absint( $button_roundness['left'] ) . 'px;
            --triphub-btn-padding-top     : ' . absint( $button_padding['top'] ) . 'px;
            --triphub-btn-padding-right   : ' . absint( $button_padding['right'] ) . 'px;
            --triphub-btn-padding-bottom  : ' . absint( $button_padding['bottom'] ) . 'px;
            --triphub-btn-padding-left    : ' . absint( $button_padding['left'] ) . 'px;
        }';

...
class triphub_Social_Lists{
     ...
     * @return void
     */
    public function triphub_lists_all_svgs( $social ){
        if( !$social ){
            return;
        }
        switch ( $social ) {
     ...
     * @return void
     */
    public function triphub_all_social_icons(){
        $social_array = [ 
            [
                'key' => 'triphub_facebook',
                'value' => '#'
            ],
            [
                'key' => 'triphub_twitter',
            ...
            [
                'key' => 'triphub_instagram',
                'value' => '#'
            ],
            [
                'key' => 'triphub_pinterest',
                'value' => ''
            ],
            [
                'key' => 'triphub_youtube',
            ...
            [
                'key' => 'triphub_linkedin',
                'value' => ''
            ],
            [
                'key' => 'triphub_whatsapp',
                'value' => ''
            ],
            [
                'key' => 'triphub_viber',
            ...
            [
                'key' => 'triphub_telegram',
                'value' => ''
            ],
            [
                'key' => 'triphub_tripadvisor',
                'value' => ''
            ]
        ];
        $social_icons = apply_filters( 'triphub_social_icons',$social_array );
     ...
     * @return void
     */
    public function triphub_social_links(){
        ...
        $list_social            = $this->triphub_all_social_icons();
        ...
        if( $ed_social_media && $social_media_order ){ ?>
                <ul class="social-networks">
                    ...
                    foreach( $social_media_order as $link ){
                        $actualsocialkey = str_replace( 'triphub_','',$link );

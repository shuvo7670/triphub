...
function triphub_customize_register_layout_blog( $wp_customize ) {
    ...
    $wp_customize->selective_refresh->add_partial( 'ed_blog_title', array(
        ...
        'render_callback' => 'triphub_get_ed_blog_title',
    ) );
    ...
    $wp_customize->add_control(
		new Triphub_Toggle_Control( 
			...
			array(
				'section' => 'blog_layout',
				'label'   => __( 'Page Description', 'triphub' ),
                'group'   => 'blog_page_title_group',
			)
		)
	);
    ...
    $wp_customize->selective_refresh->add_partial( 'ed_blog_desc', array(
        ...
        'render_callback' => 'triphub_get_ed_blog_desc',
    ) );
    ...
    $wp_customize->add_control(
		new Triphub_Radio_Buttonset_Control(
			...
			array(
				'section'	  => 'blog_layout',
				'label'       => __( 'Horizontal Alignment', 'triphub' ),
                'group'       => 'blog_page_title_group',
				'choices'	  => array(
					'left'   => __( 'Left', 'triphub' ),
					'center' => __( 'Center', 'triphub' ),
					'right'  => __( 'Right', 'triphub' ),
				),
			)
		)
	);
    ...
    $wp_customize->add_control(
        new Triphub_Group_Control( 
            ...
            array(
                'id'          => 'blog_image_group',
                'label'       => __( 'Image Setting', 'triphub' ),
                'section'     => 'blog_layout',
                'type'        => 'group',
                'style'       => 'collapsible',
                'priority'    => 20,
    ...
    $wp_customize->add_control(
        new Triphub_Group_Control( 
            ...
            array(
                ...
                'label'       => __( 'Post Settings', 'triphub' ),
                'section'     => 'blog_layout',
                'type'        => 'group',
                'style'       => 'collapsible',
                'priority'    => 30,
     ...
     $wp_customize->add_setting(
		...
		array(
			...
			'sanitize_callback' => 'triphub_sanitize_select'
		)
	);
	...
	$wp_customize->add_control(
		new Triphub_Select_Control(
    		...
    		'blog_content',
    		array(
                'label'   => __( 'Post Content', 'triphub' ),
                'section' => 'blog_layout',
                'group'   => 'blog_content_group',
                'choices' => array(
                    'content' => __( 'Content', 'triphub' ),
                    'excerpt' => __( 'Excerpt', 'triphub' ),
                ),
     		)            
		)
	);
    ...
    $wp_customize->add_control(
        new Triphub_Range_Slider_Control(
            ...
            'excerpt_length',
            array(
                'label'           => __( 'Excerpt Length', 'triphub' ),
                'description'     => __( 'Choose the number of words to display in excerpt', 'triphub' ),
                'section'         => 'blog_layout',
                'group'           => 'blog_content_group',
                'settings' => array(
    ...
    $wp_customize->add_control(
        new Triphub_Toggle_Control( 
            ...
            array(
                'section'     => 'blog_layout',
                'label'       => __( 'Show Category', 'triphub' ),
                'description' => __( 'Enable/Disable Category in the blog page.', 'triphub' ),
                'group'       => 'blog_content_group',
            )
        )
    );
    ...
    $wp_customize->add_control(
		new Triphub_Text_Control( 
			...
			array(
				'section' => 'blog_layout',
				'label'   => __( 'Read More Text', 'triphub' ),
				'group'   => 'blog_content_group',
			)
		)
	);
    ...
    $wp_customize->selective_refresh->add_partial( 'blog_read_more', array(
        ...
        'render_callback' => 'triphub_get_blog_read_more',
    ) );
    ...
    $wp_customize->add_control(
		new Triphub_Radio_Image_Control(
			...
			array(
				'section'	  => 'blog_layout',
				'label'		  => __( 'Blog Sidebar Layout', 'triphub' ),
                'svg'         => true,
                'group'       => 'blog_page_sidebar_group',  
				'choices'	  => array(
                    'default-sidebar' => array(
                        'label' => __( 'Default', 'triphub' ),
    ...
    $wp_customize->add_control(
        new WP_Customize_Cropped_Image_Control (
            ...
            'blog_header_image',
                array(
                    'label'       => __( 'Header Background Image', 'triphub' ),
                    'description' => __( 'Upload an image for blog page', 'triphub' ),
                    'section'     => 'blog_layout',
                    'flex_width'  => true,
                    'flex_height' => true,
                    'width'       => 1920,
...
add_action( 'customize_register', 'triphub_customize_register_layout_blog' );
...
function triphub_customize_register_layout_page( $wp_customize ) {
    ...
    $wp_customize->add_control(
		new Triphub_Radio_Image_Control(
			...
			array(
				'section'	  => 'single_page',
				'label'		  => __( 'Page Sidebar Layout', 'triphub' ),
                'svg'         => true,
    ...
    $wp_customize->add_control(
		new Triphub_Toggle_Control( 
			...
			array(
				'section' => 'single_page',
				'label'   => __( 'Show Featured Image', 'triphub' ),
			)
		)
	);
...
add_action( 'customize_register', 'triphub_customize_register_layout_page' );
...
function triphub_customize_register_layout_blog_archive( $wp_customize ) {
    ...
    $wp_customize->selective_refresh->add_partial( 'ed_archive_title', array(
        ...
        'render_callback' => 'triphub_get_ed_archive_title',
    ) );
    ...
    $wp_customize->add_control(
		new triphub_Toggle_Control( 
			...
			array(
				'section' => 'blog_archive_layout',
				'label'   => __( 'Show Description', 'triphub' ),
				'group'   => 'archive_title_group',
			)
		)
	);
    ...
    $wp_customize->selective_refresh->add_partial( 'ed_archive_description', array(
        ...
        'render_callback' => 'triphub_get_ed_archive_description',
    ) );
    ...
    $wp_customize->add_control(
		new triphub_Toggle_Control( 
			...
			array(
				'section' => 'blog_archive_layout',
				'label'   => __( 'Show Post Counts', 'triphub' ),
				'group'   => 'archive_title_group',
			)
		)
	);
    ...
    $wp_customize->add_control(
		new triphub_Radio_Image_Control(
			...
			array(
				'section'	  => 'blog_archive_layout',
				'label'		  => __( 'Archive Sidebar Layout', 'triphub' ),
                'svg'         => true,
        ...
        new WP_Customize_Cropped_Image_Control (
            ...
            'archive_header_image',
                array(
                    ...
                    'description' => __( 'Upload an image for archive and search pages', 'triphub' ),
                    'section'     => 'blog_archive_layout',
                    'flex_width'  => true,
                    'flex_height' => true,
                    'width'       => 1920,
...
add_action( 'customize_register', 'triphub_customize_register_layout_blog_archive' );
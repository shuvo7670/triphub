...
function triphub_customize_register_general_typography( $wp_customize ) {
    ...
    $fontsdefaults = triphub_get_general_defaults();

    /**Typography */
    $wp_customize->add_section(
        'general_typography_settings',
        array(
            'title'       => __( 'Typography', 'triphub' ),
            'priority'    => 25,
        )
    );
    ...
    $wp_customize->add_control(
		new Triphub_Toggle_Control( 
			...
			array(
				'section'     => 'general_typography_settings',
				'label'       => __( 'Load Google Fonts Locally', 'triphub' ),
				'description' => __( 'This will load Google fonts from your server to speed up your site.', 'triphub' ),
            )
		)
	);
    ...
    $wp_customize->add_control(
		new Triphub_Toggle_Control( 
			...
			array(
				'section'         => 'general_typography_settings',
				'label'           => __( 'Preload Local Fonts', 'triphub' ),
				'description'     => __( 'Preloading Google fonts will speed up your website speed.', 'triphub' ),
                'active_callback' => 'triphub_performance_fonts'
            )
		)
	);
    ...
    $wp_customize->add_control(
        'flush_google_fonts',
        array(
            'label'       => __( 'Flush Local Fonts Cache', 'triphub' ),
            'description' => __( 'Click the button to reset the local fonts cache.', 'triphub' ),
            'type'        => 'button',
            'settings'    => array(),
            'section'     => 'general_typography_settings',
            'input_attrs' => array(
                'value' => __( 'Flush Local Fonts Cache', 'triphub' ),
...
add_action( 'customize_register', 'triphub_customize_register_general_typography' );
 ...
 */
function triphub_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'triphub_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'triphub_customize_partial_blogdescription',
			)
		);
    }
    ...
    $wp_customize->add_control(
        new Triphub_Toggle_Control(
            ...
            'hide_title',
            array(
                'label'    => __( 'Hide Site Title', 'triphub' ),
    ...
    $wp_customize->add_control(
        new Triphub_Toggle_Control(
            ...
            'hide_tagline',
            array(
                'label'    => __( 'Hide Site Tagline', 'triphub' ),
                'section'  => 'title_tagline',
                'priority' => 8,
            )
        )
    ...
    $wp_customize->add_control(
        new Triphub_Group_Control( 
            ...
            array(
                'id'          => 'site_title_group',
                'label'       => __( 'Site Title Typography', 'triphub' ),
                'section'     => 'title_tagline',
                'type'        => 'group',
                'style'       => 'collapsible',
                'priorit'     => 13,
    ...
    $wp_customize->add_control(
        new Triphub_Group_Control( 
            ...
            array(
                ...
                'label'       => __( 'Site Title Colors', 'triphub' ),
                'section'     => 'title_tagline',
                'type'        => 'group',
                'style'       => 'collapsible',
            )
    ...
    $wp_customize->add_control(
        new Triphub_Alpha_Color_Customize_Control(
            ...
            'site_title_color',
            array(
                'label'    => __( 'Site Title Color', 'triphub' ),
                'section'  => 'title_tagline',
                'priority' => 14,
    ...
    $wp_customize->add_control( 
        new Triphub_Alpha_Color_Customize_Control( 
            ...
            'site_tagline_color', 
            array(
                'label'       => __( 'Site Tagline Color', 'triphub' ),
                'section'     => 'title_tagline',
                'priority'    => 14,
                'group'    => 'site_title_color_group'
            )
...
add_action( 'customize_register', 'triphub_customize_register' );
...
if( ! function_exists( 'triphub_seo_breadcrumb_ac' ) ) :
/**
* Breadcrumb Active Callback 
*/
function triphub_seo_breadcrumb_ac( $control ){
...
if( ! function_exists( 'triphub_loading_ac' ) ) :
/**
 * Active Callback for pagination
*/
function triphub_loading_ac( $control ){
...
if( ! function_exists( 'triphub_404_ac' ) ) :
/**
 * Active Callback for 404
*/
function triphub_404_ac( $control ){
...
if( ! function_exists( 'triphub_scroll_to_top_ac' ) ) :
/**
 * Active Callback for Scroll to top button
*/
function triphub_scroll_to_top_ac($control){
...
if( ! function_exists( 'triphub_performance_fonts' ) ) :
/**
*Fonts Performance Active Callback 
*/
function triphub_performance_fonts( $control ){

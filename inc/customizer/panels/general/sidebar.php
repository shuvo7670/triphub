...
function triphub_customize_register_general_sidebar( $wp_customize ){
    ...
    $wp_customize->add_control(
		new triphub_Radio_Image_Control(
			...
			array(
				...
				'label'       => __( 'Sidebar Layout', 'triphub' ),
				'description' => __( 'Choose the sidebar layout for your site.', 'triphub' ),
				'svg'         => true,
				'col'         => 'col-2',
				'choices'     => array(
                    'right-sidebar' => array(
    ...
    $wp_customize->add_control(
        new triphub_Range_Slider_Control(
            ...
            'sidebar_width',
            array(
                'label'    => __( 'Sidebar Width', 'triphub' ),
                'section'  => 'general_sidebar_section',
                'settings' => array(
    ...
    $wp_customize->add_control(
        new triphub_Range_Slider_Control(
            ...
            'widgets_spacing',
            array(
                'label'    => __( 'Widget Spacing', 'triphub' ),
                'section'  => 'general_sidebar_section',
                'settings' => array(
    ...
    $wp_customize->add_control(
		new triphub_Toggle_Control( 
			...
			array(
				'section'	  => 'general_sidebar_section',
				'label'		  => __( 'Last Widget Sticky', 'triphub' ),
			)
		)
	);

}
add_action( 'customize_register', 'triphub_customize_register_general_sidebar' );
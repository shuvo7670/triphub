...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Triphub_Range_Slider_Control' ) ) {
	...
	class Triphub_Range_Slider_Control extends WP_Customize_Control {
		...
		public function to_json() {
			...
			$this->json['desktop_label'] = __( 'Desktop', 'triphub' );
			$this->json['tablet_label']  = __( 'Tablet', 'triphub' );
			$this->json['mobile_label']  = __( 'Mobile', 'triphub' );
			$this->json['reset_label']   = __( 'Reset', 'triphub' );

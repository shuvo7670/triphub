 ...
 */
function triphub_get_alpha_value_from_color( value ) {
	var alphaVal;
 ...
 */
 function triphub_update_alpha_value_on_color_control( alpha, $control, $alphaSlider, update_slider ) {
	...
	if ( update_slider ) {
		triphub_update_alpha_value_on_alpha_slider( alpha, $alphaSlider );
	}
 ...
 */
function triphub_update_alpha_value_on_alpha_slider( alpha, $alphaSlider ) {
...
jQuery( document ).ready( function( $ ) {
	...
	$( '.travel-monster-color-alpha-control' ).each( function() {
		...
		alphaVal = triphub_get_alpha_value_from_color( startingColor );
		...
		$container.find( '.iris-palette' ).on( 'click', function() {
			...
			alpha = triphub_get_alpha_value_from_color( color );
		...
		$container.find( '.button.wp-picker-clear' ).on( 'click', function() {
			...
			triphub_update_alpha_value_on_alpha_slider( 100, $alphaSlider );
		});

		// Bind event handler for clicking on the 'Default' button.
		$container.find( '.button.wp-picker-default' ).on( 'click', function() {
			var alpha = triphub_get_alpha_value_from_color( defaultColor );
		...
		$control.on( 'input', function() {
			...
			if ( '' === value ) {
				...
				var alpha = triphub_get_alpha_value_from_color( value );
		...
		$alphaSlider.slider().on( 'slide', function( event, ui ) {
			...
			triphub_update_alpha_value_on_color_control( alpha, $control, $alphaSlider, false );
		});

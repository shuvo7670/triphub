...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'triphub_Typography_Customize_Control' ) ) {
	...
	class triphub_Typography_Customize_Control extends WP_Customize_Control {
		...
		public function to_json() {
			...
			$this->json['default_fonts_title'] = __( 'System fonts', 'triphub' );
			$this->json['google_fonts_title']  = __( 'Google fonts', 'triphub' );
			$this->json['default_fonts']       = triphub_typography_default_fonts();
			$this->json['family_title']        = esc_html__( 'Font Family', 'triphub' );
			$this->json['weight_title']        = esc_html__( 'Font Weight', 'triphub' );
			$this->json['transform_title']     = esc_html__( 'Transform', 'triphub' );
			$this->json['category_title']      = '';
			$this->json['variant_title']       = esc_html__( 'Variants', 'triphub' );

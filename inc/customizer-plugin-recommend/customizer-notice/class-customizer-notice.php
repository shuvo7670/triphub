...
class triphub_Customizer_Notice {
	...
	/**
	 * The single instance of triphub_Customizer_Notice
	 *
	 * @var triphub_Customizer_Notice $instance The triphub_Customizer_Notice instance.
	 */
	...
	/**
	 * The Main triphub_Customizer_Notice instance.
	 *
	 * We make sure that only one instance of triphub_Customizer_Notice exists in the memory at one time.
	 *
	 * @param array $config The configuration array.
	 */
	public static function init( $config ) {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof triphub_Customizer_Notice ) ) {
			self::$instance = new triphub_Customizer_Notice;
	...
	public function setup_config() {
		...
		$triphub_recommended_plugins = array();
		
		if ( isset( $this->recommended_plugins ) ) {
			$triphub_recommended_plugins = $this->recommended_plugins;
		}
	...
	public function scripts_for_customizer() {
		...
		wp_localize_script(
            ...
            array(
				...
				'base_path'          => admin_url(),
				'activating_string'  => __( 'Activating', 'triphub' ),
			)
		);
	}
	...
	public function customize_register_notice( $wp_customize ) {
		/**
		 * Include the triphub_Customizer_Notice_Section class.
		 */
	...
	public function dismiss_recommended_plugins_callback() {
		...
		if ( ! empty( $action_id ) ) {
			...
			update_option( 'triphub_show_recommended_plugins', $show_recommended_plugins );
		}

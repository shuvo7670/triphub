 ...
 * @return array
 */
function triphub_get_site_defaults(){
    ...
    return apply_filters( 'triphub_site_options_defaults', $defaults );
}
endif;

if( ! function_exists( 'triphub_get_typography_defaults' ) ) :
/**
 * Typography Defaults
 * 
 * @return array
 */
function triphub_get_typography_defaults(){
    $defaults = array(
    ...
    return apply_filters( 'triphub_typography_options_defaults', $defaults ); 
}
endif;

if( ! function_exists( 'triphub_get_color_defaults' ) ) :
/**
 * Color Defaults
 * 
 * @return array
 */
function triphub_get_color_defaults(){
    $defaults = array(
        'primary_color'                     => '#6432e3',
        ...
        'btn_bg_color_hover'                => '#6432e3',
        'btn_border_color_initial'          => '#e48e45',
        'btn_border_color_hover'            => '#6432e3',
        'notification_bg_color'             => '#6432e3',
        ...
        'top_header_bg_color'               => '#6432e3',
        'top_header_text_color'             => '#ffffff',
    );

    return apply_filters( 'triphub_color_options_defaults', $defaults );
}
endif;

if( ! function_exists( 'triphub_get_button_defaults' ) ) :
/**
 * Button Defaults
 * 
 * @return array
 */
function triphub_get_button_defaults(){
    ...
    return apply_filters( 'triphub_button_options_defaults', $defaults );
}
endif;

if( ! function_exists( 'triphub_get_general_defaults' ) ) :
/**
 * General Defaults
 * 
 * @return array
 */
function triphub_get_general_defaults(){
    ...
    $defaults = array(
        ...
        'blog_read_more'                => __( 'Read More', 'triphub' ),
        ...
        'single_related_title'          => __( 'Recommended Articles','triphub' ),
        ...
        'ed_og_tags'                    => true,
        'social_share_text'             => __( 'SHARE THIS ARTICLE:', 'triphub' ),
        ...
        'load_more_label'               => __( 'Load More Posts', 'triphub' ),
        'loading_label'                 => __( 'Loading...', 'triphub' ),
        'no_more_label'                 => __( 'No More Post', 'triphub' ),
        'home_text'                     => __( 'Home', 'triphub' ),
        'separator_icon'                => 'one',
        ...
        'header_layout'                 => 'one',
        'header_button_label'           => __( 'Book Now','triphub' ),
        'header_button_link'            => '',
        ...
        'social_media_order'            => array( 'triphub_facebook', 'triphub_twitter', 'triphub_instagram'),
        ...
        'triphub_email_label'               => '',
        'triphub_email'                     => '',
        'mobile_menu_label'             => __('Menu', 'triphub'),
        ...
        'ed_wp_link'                    => false,
        'payment_label'                 => __( 'Secured Payment:','triphub' ),
        'payment_image'                 => '',
        '404_image'                     => '',
        'blog_header_image'             => '',
    ...
    return apply_filters( 'triphub_general_defaults', $defaults );
}
endif;
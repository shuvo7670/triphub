...
if( ! function_exists( 'triphub_get_currency_converter_template' ) ) :
/**
 * Get template for WTE currency converter dropdown
 */
function triphub_get_currency_converter_template(){
...
if ( triphub_is_currency_converter_activated() ){
	add_filter( 'wte_cc_display_list', 'triphub_get_currency_converter_template' );
}
...
function triphub_overall_average_custom_template_path(){
...
add_filter( 'wp_travel_engine_trip_reviews_filtered_template_path','triphub_overall_average_custom_template_path' );
 ...
 * @return void
 */
function triphub_adding_sticky_sidebar_form() {
...
add_filter( 'wpte_bf_outer_wrapper_classes', 'triphub_adding_sticky_sidebar_form' );